...
exports.getIsPastDue = exports.getIsTodayButFuture = exports.getIsWithinFutureDays = exports.oneDayMs = exports.formatDate = exports.getDueDateFromIssueBody = exports.getIsValidDate = void 0;
...
const getIsWithinFutureDays = (date, days) => {
    ...
    return diff <= (exports.oneDayMs * days);
};
exports.getIsWithinFutureDays = getIsWithinFutureDays;
