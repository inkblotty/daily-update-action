...
const teamShowAndSupport_1 = require("./teamShowAndSupport");
...
const aggregateAndFormatUpdates = (repo, owner) => __awaiter(void 0, void 0, void 0, function* () {
    const teamShowAndSupportUpdates = yield (0, teamShowAndSupport_1.default)(github.getOctokit(GH_TOKEN), { repo, owner });
